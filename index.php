...
<head>
    <title>CrowXworst | Trang chủ</title>
    <meta charset="utf-8">
...
<body class="preloading">
    ...
    <section class="main clearfix">
        ...
        <a href="./manga_detail.php?id_manga=5"><img src="./img/Crows_Explode_poster.jpeg.jpg" alt="" srcset="">
            ...
            <a href="./manga_detail.php?id_manga=8"><img src="./img/We_Are_The_Worst.jpg" alt="" srcset=""></a>
            <a href="./manga_detail.php?id_manga=8"><img src="./img/Umehoshi.JPG.jpg" alt="" srcset=""></a>
            <a href="./manga_detail.php?id_manga=9"><img src="./img/Harumichi.jpg" alt="" srcset=""></a>
    </section>
    <!-- end main -->
