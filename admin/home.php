...
<head>
    ...
    <link rel="shortcut icon" href="./../img/crow-head-vector-24390236.jpg">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <?php require_once './pages/forms/nav_admin.php'; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                ...
                                <div class="icon">
                                <i class="fab fa-old-republic"></i>                                </div>
                                <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="dist/img/by.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="dist/img/hn.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
