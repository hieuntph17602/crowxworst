            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="./../../../db/post_cate/store.php" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên loại bài viết</label>
                                    <input type="text" class="form-control" name="post_category_name" id="exampleInputEmail1" placeholder="Nhập tên bài viết">
                                </div>
                            </div>
                            <!-- /.card-body -->
